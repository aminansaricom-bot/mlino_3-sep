param(
    ...
    [string] $CoreModels = 'mlino2/validation/g3b/prisma/core-models.prisma',
    [string] $OutputSchema = 'C:/Users/galexy/mlino code/g3b-tooling/core-schema.prisma',
    [string] $GeneratedClientOutput = 'C:/Users/galexy/mlino code/g3b-tooling/generated-client'
)
