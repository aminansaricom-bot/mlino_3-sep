...
## به‌روزرسانی ۱۱ سپتامبر ۲۰۲۶ — بنیاد Intent

Foundation نشست و دستیار به‌عنوان مبنای مستقل حفظ شد؛ Intent Flow Foundation پیاده و با ۲۰۱ تست، TypeScript، build و Chrome موبایل/دسکتاپ اعتبارسنجی شد. وضعیت: آماده بازبینی. [مرز این مرحله](HANDOFF/20260911_INTENT_FLOW_DESIGN.md).

گام بعد فقط پس از بازبینی و مجوز جدا: بازنمایی معنایی محلی و قیود صریح نیاز. Matching، Ranking، Directory، V1، persistence و AR در این تحویل شروع نشده‌اند؛ برنامه وسیع‌تر زیر به‌معنای تکمیل Local Discovery نیست.
