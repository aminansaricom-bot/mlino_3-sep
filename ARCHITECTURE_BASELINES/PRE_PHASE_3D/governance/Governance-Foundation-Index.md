...
This index connects three layers of record: the frozen Kernel, the five-ADR AI Governance chain built on top of it, and the Compliance Audit that traces one to the other. All items below are additive relative to Kernel Architecture Specification v1.2 — none required or produced a Kernel revision.

## Layer 1 — Kernel (Frozen, Immutable)

- `../Kernel_Architecture_v1.2_FROZEN.md`
